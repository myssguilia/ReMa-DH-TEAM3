...
Our findings suggest that different attack types were indeed associated with different GDP levels across both surge periods, though the nature of this association shifted between the two intervals. In 1998-2003, hijackings were recorded as occurring in relatively higher-GDP countries compared to boarded attacks. In 2006-2011, this pattern reversed, with boarded attacks associated with higher GDP contexts and hijacking clustering towards lower GDP environments. It is also important to note that despite these differences, on a global scale all of the categories of pirate attacks still tend to happen in countries with a relatively low GDP. This change is consistent with the geographical shift documented by [Rivas Pardo (2021)](https://revistas.umng.edu.co/index.php/ries/article/view/5282): as most piracy activity moved from Southeast Asia to Africa during the second period, the economic profile of the contries in which different attack types occurred changed accordingly. These results therefore at least partially support the working thesis, confirming that hijackings after the Somali surge have concentrated in lower-GDP contexts, while boarded attacks, increasingly occurring in the relatively wealthier waters of Southeast Asia, were associated with higher GDP values.
...
We think the effectiveness of our workflow is good, because the results align with the research question. It was supposed to achieve an answer to the research question for us, which it does.  However, we also learned about the constraints. The workflow took us an enormous amount of time, because we had a hard time coming up with an innovative research idea. Keeping our team’s skills in mind, it took us a lot of time to decide on a research question where we felt like we could actually answer it. Luckily, Jelmer had done a course on QGIS before and Giulia has Python skills. Unfortunately, one of the biggest obstacles we had to overcome was the lack of (trust in our) statistics skills. Coming up with a statistical analysis that we were actually able to execute. So time management is where the workflow could have been more effective.  

For future extended research, we were having thoughts on extending the research to more different kinds of attacks as attested in the original dataset. Researching the other given attack types might give interesting insights in the correlation between socioeconomic variables and other attack types, e.g. suspicious attacks or explosions. For future improvements, we want to mention the possibility of “cleaning” the dataset even more, in the sense of making sure that occurrences of contested sea territories and differences between boarded and boarding are solved and handled consistently. Another focus point mentioned in the team was the possibility of looking into the choke points more.
